 ...
 *  Dingo.java Copyright (C) 2020 Daniel H. Huson
 *
 *  (Some files contain contributions from other authors, who are then mentioned separately.)
 *
 *  This program is free software: you can redistribute it and/or modify
...
public class Dingo extends Application {
    /**
     * main
     *
     * @param args
    ...
    public static void main(String[] args) throws CanceledException, UsageException {
        ...
        ResourceManagerFX.addResourceRoot(Dingo.class, "phyloedit.resources");
    ...
    protected static void parseArguments(String[] args) throws CanceledException, UsageException {
        final ArgsOptions options = new ArgsOptions(args, Dingo.class, Version.NAME + " - Directed network generator");
        ...
        if (ProgramProperties.isMacOS())
            defaultPropertiesFile = System.getProperty("user.home") + "/Library/Preferences/Dingo.def";
        else
            defaultPropertiesFile = System.getProperty("user.home") + File.separator + ".Dingo.def";
        ...
        if (showVersion) {
            ...
            System.err.println(jloda.util.Version.getVersion(Dingo.class, ProgramProperties.getProgramName()));
