...
public class LSATree {
    ...
    private NodeArray<BitSet> ret2PathSet;
    private NodeArray<EdgeArray<BitSet>> ret2Edge2PathSet;
    private NodeArray<Node> reticulation2LSA;
    private NodeArray<Set<Node>> node2below;
